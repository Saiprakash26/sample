...
import './Fashion.css'
import ione from './k14.jpeg'
import itwo from './k13.jpeg'
import ithree from './k3.jpeg'
import ifour from './k4.jpeg'
import ifive from './k5.jpeg'
import isix from './kk1.jpeg'
         ...
         <div className="card mb-3 p-5 container mt-5">
                <div className="row g-0">
                    ...
                    <div className="col-md-6">
                        <div className="card-body w-100">
                            <h5 className="card-title">Kids Meedi</h5>
            ...
            <div className="card mb-3 p-5 container mt-5">
                <div className="row g-0">
                    ...
                    <div className="col-md-6">
                        <div className="card-body w-100">
                            <h5 className="card-title"> Kids Gown</h5>
            ...
            <div className="card mb-3 p-5 container mt-5">
                <div className="row g-0">
                    ...
                    <div className="col-md-6">
                        <div className="card-body w-100">
                            <h5 className="card-title">Kids Court Suits</h5>
                            <h4 className="card-text">25 % Offer</h4>
                            <h4 className="card-text"><small className="text-body-dark">Orginal Price: <del>1500</del> BF Price :1125</small></h4>
                            <h6 className="card-text">Avaliable Size</h6>
            ...
            <div className="card mb-3 p-5 container mt-5">
                <div className="row g-0">
                    ...
                    <div className="col-md-6">
                        <div className="card-body w-100">
                            <h5 className="card-title">Over Coat Shirts</h5>
                            <h4 className="card-text">30 % Offer</h4>
                            <h4 className="card-text"><small className="text-body-dark">Orginal Price: <del>1500</del> BF Price :1050</small></h4>
                            <h6 className="card-text">Avaliable Size</h6>
            ...
            <div className="card mb-3 p-5 container mt-5">
                <div className="row g-0">
                    ...
                    <div className="col-md-6">
                        <div className="card-body w-100">
                            <h5 className="card-title">Kids Top Casuals</h5>
                            <h4 className="card-text">25 % Offer</h4>
                            <h4 className="card-text"><small className="text-body-dark">Orginal Price: <del>1500</del> BF Price :1125</small></h4>
                            <h6 className="card-text">Avaliable Size</h6>
            ...
            <div className="card mb-3 p-5 container mt-5">
                <div className="row g-0">
                    ...
                    <div className="col-md-6">
                        <div className="card-body w-100">
                            <h5 className="card-title">Kid Shirts Pants </h5>
                            <h4 className="card-text">25 % Offer</h4>
